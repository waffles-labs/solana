...
impl DefaultSigner {
    ...
    /// use waffles_solana_clap_utils::keypair::DefaultSigner;
    /// use waffles_solana_clap_utils::offline::OfflineArgs;
    ///
    ...
    /// ```no_run
    /// use clap::{App, Arg, value_t_or_exit};
    /// use waffles_solana_clap_utils::keypair::{DefaultSigner, signer_from_path};
    /// use waffles_solana_clap_utils::offline::OfflineArgs;
    ...
    /// ```no_run
    /// use clap::{App, Arg, value_t_or_exit};
    /// use waffles_solana_clap_utils::keypair::{SignerFromPathConfig, DefaultSigner};
    /// use waffles_solana_clap_utils::offline::OfflineArgs;
    ///
    /// let clap_app = App::new("my-program")
    ///     // The argument we'll parse as a signer "path"
...
/// ```no_run
/// use clap::{App, Arg, value_t_or_exit};
/// use waffles_solana_clap_utils::keypair::signer_from_path;
/// use waffles_solana_clap_utils::offline::OfflineArgs;
///
/// let clap_app = App::new("my-program")
///     // The argument we'll parse as a signer "path"
...
/// ```no_run
/// use clap::{App, Arg, value_t_or_exit};
/// use waffles_solana_clap_utils::keypair::{signer_from_path_with_config, SignerFromPathConfig};
/// use waffles_solana_clap_utils::offline::OfflineArgs;
///
/// let clap_app = App::new("my-program")
///     // The argument we'll parse as a signer "path"
...
/// ```no_run
/// use clap::{App, Arg, value_t_or_exit};
/// use waffles_solana_clap_utils::keypair::pubkey_from_path;
///
/// let clap_app = App::new("my-program")
///     // The argument we'll parse as a signer "path"
///     .arg(Arg::with_name("keypair")
...
/// ```no_run
/// use clap::{App, Arg, value_t_or_exit};
/// use waffles_solana_clap_utils::keypair::keypair_from_path;
///
/// let clap_app = App::new("my-program")
///     // The argument we'll parse as a signer "path"
///     .arg(Arg::with_name("keypair")
