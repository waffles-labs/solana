...
use waffles_solana_entry::entry::{self, create_ticks, init_poh, EntrySlice, VerifyRecyclers};
#[cfg(not(any(target_arch = "x86", target_arch = "x86_64")))]
use waffles_solana_entry::entry::{create_ticks, init_poh, EntrySlice, VerifyRecyclers};
use {
